    ...
    public function getAllAdmin() {
        ...
        return datatables($requests)
            ...
            ->addColumn('action', function($request) {
                $markCompleteBtn = $request->is_completed ? '' : "<button class='btn btn-success btn-sm' onclick='selectRequest({$request->id});' title='Mark as Complete' data-bs-toggle='modal' data-bs-target='#markAsCompletedModal'><i class='bx bx-check-square me-0'></i></button>";
