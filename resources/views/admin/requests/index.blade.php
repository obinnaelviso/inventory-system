...
@push('js')
    ...
    <script src="{{ asset('js/admin/requests.js') }}?555"></script>
@endpush
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <livewire:admin.requests-form :depts="$depts" />
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="requestDeleteModal" tabindex="-1" aria-labelledby="requestDeleteModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="markAsCompletedModal" tabindex="-1" aria-labelledby="markAsCompletedModalLabel"
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Not yet</button>
                    <button type="button" class="btn btn-success btn-sm" id="modalDeleteBtn"
