...
<script src="{{ asset('js/admin/stocks-items.js') }}"></script>
@endpush
...
@push('modals')
    ...
    <div class="modal fade" id="stockItemDeleteModal" tabindex="-1" aria-labelledby="stockItemDeleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="stockItemDeleteModalTitle">Delete Item</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
