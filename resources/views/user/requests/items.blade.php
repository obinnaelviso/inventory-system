                                ...
                                <div class="col-12">
                                    @if ($request->status_id != status_processing_id())
                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#requestItemFormModal" onclick="addRequestItem()">
                                    ...
                                    @else
                                        <span class="text-{{ $request->status->colour[0] }}"> <i class="bx bx-check"></i>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="requestItemsTable"
                                data-get-url="{{ route('user.requests.items.index', $request->id) }}" class="table">
                                <thead>
                                    <tr>
                                        <th width="5%">SL#</th>
                                        <th width="15%">Item</th>
...
@push('js')
    ...
    <script src="{{ asset('js/user/request-items.js') }}?555"></script>
@endpush

@push('modals')
    <!-- New/Update Modal -->
    <div class="modal fade" id="requestItemFormModal" tabindex="-1" aria-labelledby="userFormModalLabel"
        aria-hidden="true">
    ...
    {{-- Delete --}}
    <div class="modal fade" id="requestItemDeleteModal" tabindex="-1" aria-labelledby="deleteUserModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-sm" id="modalDeleteBtn"
                        onclick="confirmRequestItemDelete();">Delete</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="submitRequestModal" tabindex="-1" aria-labelledby="submitRequestModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Not yet</button>
                    <button type="button" class="btn btn-success btn-sm" id="modalSubmitBtn"
                        onclick="submitRequest();">Yes</button>
                </div>
            </div>
        </div>
    </div>
